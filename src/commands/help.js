...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor(0x2b2d31)
            .addFields(
                { name: 'Economy',      value: '`/bank balance` `/bank deposit` `/bank withdraw` `/give` `/work` `/daily` `/beg` `/lottery`', inline: false },
                { name: 'Activities',   value: '`/search <location>` `/crime <type>` `/shop`', inline: false },
